...
knitr::opts_chunk$set(root.dir = "/projects/fratis/npmrds")
password <- scan("~/.pgpasswd", what = "character", quiet = TRUE)
fratis <- connect(dbname = "fratis", password = password)
sqldf.pg.options(dbname = "fratis")
library(knitr)
library(kableExtra)
library(captioner)
library(reshape2)
